...
function SettingsDialog() {
  ...
  if (!open) return null;
  const persistBackground = (file: File) => { const reader = new FileReader(); reader.onload = () => setAppearance({ backgroundUrl: typeof reader.result === 'string' ? reader.result : null }); reader.readAsDataURL(file); };
